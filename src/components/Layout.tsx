    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex flex-1 flex-col lg:flex-row relative">
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-64 bg-hospital-900 text-white shrink-0 shadow-lg sticky top-0 h-screen z-20">
          ...
          {/* Clinic Brand header */}
          <div className="h-20 flex items-center gap-3 px-6 border-b border-hospital-800">
            <img
              src={LOGO_URL}
              alt="BHH Logo"
              className="h-12 w-12 object-contain rounded-xl bg-white p-1.5 shadow"
            />
            ...
            <div>
              ...
              <p className="text-[10px] text-hospital-400 font-medium">PATIENT PROFILE SYSTEM</p>
        ...
        {/* Mobile Nav Sidebar */}
        <div className={`lg:hidden fixed top-16 bottom-0 left-0 w-64 bg-hospital-900 text-white z-40 transition-transform duration-300 ease-in-out transform ${
